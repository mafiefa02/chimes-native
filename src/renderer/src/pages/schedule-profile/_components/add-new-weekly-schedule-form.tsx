...
import { useCreateWeeklyScheduleForm } from '../_forms/weekly-schedule/hooks/use-create-weekly-schedule-form';
import { format } from 'date-fns';
import { CalendarIcon } from 'lucide-react';
import { ReactNode, useEffect } from 'react';
import { toast } from 'sonner';

interface AddNewWeeklyScheduleFormProps {
  formAction: ReactNode;
  closeDialog: () => void;
  selectedDay: number;
}

export const AddNewWeeklyScheduleForm = ({
  formAction,
  closeDialog,
  selectedDay,
}: AddNewWeeklyScheduleFormProps) => {
  const { form, onSubmit } = useCreateWeeklyScheduleForm({
    selectedDay,
